...
public class EconomicIndicatorsApp {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Add these World Bank indicators
            String retailSalesData = WorldBank.fetchData("NE.CON.PRVT.ZS", "US", 2013, 2023);
            String foreignInvestmentData = WorldBank.fetchData("BX.KLT.DINV.WD.GD.ZS", "US", 2013, 2023);
            String exportData = WorldBank.fetchData("NE.EXP.GNFS.ZS", "US", 2013, 2023);

            // Add these FRED indicators
            String industrialProductionData = fetchFredData("INDPRO", "2013-01-01", "2023-12-31", config.getFredApiKey());
            String housingStartsData = fetchFredData("HOUST", "2013-01-01", "2023-12-31", config.getFredApiKey());
